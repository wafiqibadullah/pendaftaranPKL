...
<section class="panel">
		<header class="panel-heading">
					<div class="panel-actions">
								...
								<h2 class="panel-title">Data Pembimbing</h2>
							</header>
							<div class="panel-body">
								<div class="row">
									<div class="col-md-9">
										<div class="mb-md">
											<a href="{{ route('admin.createpembimbing') }}" id="addToTable" class="btn btn-primary">Add <i class="fa fa-plus"></i></a>
										</div>
										</div>
									<div class="col-md-3">
										<label>
		   ...
		   <td>   {{ $siswa->tempat_lahir }} , {{ $siswa->tgl_lahir }}</td>
            ...
            <td class="actions">
		              <form action="{{ route('pembimbing.destroyed', $siswa ) }}" method="post" class="">
		                  {{ csrf_field() }}
					        {{ method_field('DELETE') }}
			     <a href="{{ route('pembimbing.editpembimbing', $siswa ) }}" class="on-default edit-row" ><i class="fa fa-pencil"></i> </a>
       ...
       <?php endforeach ?>
			...
			<div class="container">
				...
				<a href="{{ route('admin.bacadatapembimbinggg') }}" class="btn btn-success btn-xs">Back</a>
			</div>
