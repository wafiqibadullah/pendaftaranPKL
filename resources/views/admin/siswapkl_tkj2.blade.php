...
<section class="panel">
		<header class="panel-heading">
					<div class="panel-actions">
								...
								<h2 class="panel-title">Data Siswa PKL XI TKJ 2</h2>
							</header>
							<div class="panel-body">
								<div class="row">
									<div class="col-md-9">
										<div class="mb-md">
											<a href="/admin/SiswaPKL/TKJ2/create" id="addToTable" class="btn btn-primary">Pembagian Pembimbing PKL <i class="fa fa-plus"></i></a>
										</div>
										</div>
									<div class="col-md-3">
										<!-- <label>
