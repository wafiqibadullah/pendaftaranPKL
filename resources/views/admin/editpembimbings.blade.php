...
<!-- <a class="btn" href="bacadatasiswa.php"><span class="glyphicon glyphicon-arrow-left"></span>  Kembali</a>
 -->				
	<form class="" action="{{ route('pembimbing.updatedd', $siswa) }}" method="post">
        {{ csrf_field() }}
        {{ method_field('PATCH') }}
		<table class="table">
			...
			<tr>
				...
				<td><input type="text" required class="form-control" name="nama_pembimbing" value="{{ $siswa->nama_pembimbing }}"></td>
			</tr>
			<tr>
				<td>Jenis Kelamin</td>
