...
<form action="{{ route('admin.storekaryatulis') }}" method="post">
	{{ csrf_field() }}
				...
				<div class="row">
							...
							<section class="panel">
								<header class="panel-heading">
									<div class="panel-actions">
										...
										<h2 class="panel-title">Tambah Data Pembimbing Karya Tulis</h2>
								</header>
					...
					<div class="form-group">
						...
						<input name="nama_pembimbing_karya" required type="text" class="form-control" placeholder="Nama Pembimbing ..">
					</div>
